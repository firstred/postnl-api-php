...
.. php:interface:: LocationServiceResponseProcessorInterface
...
* :php:meth:`public processGetNearestLocationsResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\LocationServiceResponseProcessorInterface::processGetNearestLocationsResponse\(\)>`
* :php:meth:`public processGetLocationsInAreaResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\LocationServiceResponseProcessorInterface::processGetLocationsInAreaResponse\(\)>`
* :php:meth:`public processGetLocationResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\LocationServiceResponseProcessorInterface::processGetLocationResponse\(\)>`
