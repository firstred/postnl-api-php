...
* :php:meth:`public getDeliveryDate\($getDeliveryDate\)<Firstred\\PostNL\\Service\\DeliveryDateServiceInterface::getDeliveryDate\(\)>`
* :php:meth:`public getSentDate\($getSentDate\)<Firstred\\PostNL\\Service\\DeliveryDateServiceInterface::getSentDate\(\)>`
