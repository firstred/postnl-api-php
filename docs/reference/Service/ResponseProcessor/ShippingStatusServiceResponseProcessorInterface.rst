...
.. php:interface:: ShippingStatusServiceResponseProcessorInterface
...
* :php:meth:`public processCurrentStatusResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\ShippingStatusServiceResponseProcessorInterface::processCurrentStatusResponse\(\)>`
* :php:meth:`public processCompleteStatusResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\ShippingStatusServiceResponseProcessorInterface::processCompleteStatusResponse\(\)>`
* :php:meth:`public processGetSignatureResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\ShippingStatusServiceResponseProcessorInterface::processGetSignatureResponse\(\)>`
* :php:meth:`public processGetUpdatedShipmentsResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\ShippingStatusServiceResponseProcessorInterface::processGetUpdatedShipmentsResponse\(\)>`
