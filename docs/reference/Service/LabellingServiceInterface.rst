...
.. php:interface:: LabellingServiceInterface
...
* :php:meth:`public generateLabelREST\($generateLabel, $confirm\)<Firstred\\PostNL\\Service\\LabellingServiceInterface::generateLabelREST\(\)>`
* :php:meth:`public generateLabelsREST\($generateLabels\)<Firstred\\PostNL\\Service\\LabellingServiceInterface::generateLabelsREST\(\)>`
* :php:meth:`public generateLabelSOAP\($generateLabel, $confirm\)<Firstred\\PostNL\\Service\\LabellingServiceInterface::generateLabelSOAP\(\)>`
* :php:meth:`public generateLabelsSOAP\($generateLabels\)<Firstred\\PostNL\\Service\\LabellingServiceInterface::generateLabelsSOAP\(\)>`
* :php:meth:`public buildGenerateLabelRequestREST\($generateLabel, $confirm\)<Firstred\\PostNL\\Service\\LabellingServiceInterface::buildGenerateLabelRequestREST\(\)>`
* :php:meth:`public processGenerateLabelResponseREST\($response\)<Firstred\\PostNL\\Service\\LabellingServiceInterface::processGenerateLabelResponseREST\(\)>`
* :php:meth:`public buildGenerateLabelRequestSOAP\($generateLabel, $confirm\)<Firstred\\PostNL\\Service\\LabellingServiceInterface::buildGenerateLabelRequestSOAP\(\)>`
* :php:meth:`public processGenerateLabelResponseSOAP\($response\)<Firstred\\PostNL\\Service\\LabellingServiceInterface::processGenerateLabelResponseSOAP\(\)>`
