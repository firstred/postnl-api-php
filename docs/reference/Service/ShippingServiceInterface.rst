...
* :php:meth:`public sendShipmentRest\($sendShipment, $confirm\)<Firstred\\PostNL\\Service\\ShippingServiceInterface::sendShipmentRest\(\)>`
* :php:meth:`public buildSendShipmentRequestREST\($sendShipment, $confirm\)<Firstred\\PostNL\\Service\\ShippingServiceInterface::buildSendShipmentRequestREST\(\)>`
* :php:meth:`public processSendShipmentResponseREST\($response\)<Firstred\\PostNL\\Service\\ShippingServiceInterface::processSendShipmentResponseREST\(\)>`
