...
.. php:class:: CompleteStatusByPhase
...
* :php:meth:`public \_\_construct\($Shipment, $Customer, $Message\)<Firstred\\PostNL\\Entity\\Request\\CompleteStatusByPhase::\_\_construct\(\)>`
* :php:meth:`public xmlSerialize\($writer\)<Firstred\\PostNL\\Entity\\Request\\CompleteStatusByPhase::xmlSerialize\(\)>`
