...
.. php:interface:: TimeframeServiceResponseProcessorInterface
...
* :php:meth:`public processGetTimeframesResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\TimeframeServiceResponseProcessorInterface::processGetTimeframesResponse\(\)>`
