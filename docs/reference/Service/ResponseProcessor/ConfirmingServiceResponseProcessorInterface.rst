...
.. php:interface:: ConfirmingServiceResponseProcessorInterface
...
* :php:meth:`public processConfirmResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\ConfirmingServiceResponseProcessorInterface::processConfirmResponse\(\)>`
