...
.. php:class:: DeliveryDateServiceRestResponseProcessor
	...
	:Implements:
		:php:interface:`Firstred\\PostNL\\Service\\ResponseProcessor\\DeliveryDateServiceResponseProcessorInterface` 
...
* :php:meth:`public processGetDeliveryDateResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\Rest\\DeliveryDateServiceRestResponseProcessor::processGetDeliveryDateResponse\(\)>`
* :php:meth:`public processGetSentDateResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\Rest\\DeliveryDateServiceRestResponseProcessor::processGetSentDateResponse\(\)>`
