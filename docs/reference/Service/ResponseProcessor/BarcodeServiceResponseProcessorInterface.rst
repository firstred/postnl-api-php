...
.. php:interface:: BarcodeServiceResponseProcessorInterface
...
* :php:meth:`public processGenerateBarcodeResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\BarcodeServiceResponseProcessorInterface::processGenerateBarcodeResponse\(\)>`
