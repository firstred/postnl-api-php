...
* :php:meth:`public getNearestLocations\($getNearestLocations\)<Firstred\\PostNL\\Service\\LocationServiceInterface::getNearestLocations\(\)>`
* :php:meth:`public getLocationsInArea\($getLocations\)<Firstred\\PostNL\\Service\\LocationServiceInterface::getLocationsInArea\(\)>`
* :php:meth:`public getLocation\($getLocation\)<Firstred\\PostNL\\Service\\LocationServiceInterface::getLocation\(\)>`
