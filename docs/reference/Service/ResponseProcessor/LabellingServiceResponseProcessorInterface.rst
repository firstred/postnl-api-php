...
.. php:interface:: LabellingServiceResponseProcessorInterface
...
* :php:meth:`public processGenerateLabelResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\LabellingServiceResponseProcessorInterface::processGenerateLabelResponse\(\)>`
