...
* :php:meth:`public generateBarcode\($generateBarcode\)<Firstred\\PostNL\\Service\\BarcodeServiceInterface::generateBarcode\(\)>`
* :php:meth:`public generateBarcodes\($generateBarcodes\)<Firstred\\PostNL\\Service\\BarcodeServiceInterface::generateBarcodes\(\)>`
