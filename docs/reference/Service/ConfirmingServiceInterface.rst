...
* :php:meth:`public confirmShipmentREST\($confirming\)<Firstred\\PostNL\\Service\\ConfirmingServiceInterface::confirmShipmentREST\(\)>`
* :php:meth:`public confirmShipmentsREST\($confirms\)<Firstred\\PostNL\\Service\\ConfirmingServiceInterface::confirmShipmentsREST\(\)>`
* :php:meth:`public confirmShipmentSOAP\($confirming\)<Firstred\\PostNL\\Service\\ConfirmingServiceInterface::confirmShipmentSOAP\(\)>`
* :php:meth:`public confirmShipmentsSOAP\($confirmings\)<Firstred\\PostNL\\Service\\ConfirmingServiceInterface::confirmShipmentsSOAP\(\)>`
* :php:meth:`public buildConfirmRequestREST\($confirming\)<Firstred\\PostNL\\Service\\ConfirmingServiceInterface::buildConfirmRequestREST\(\)>`
* :php:meth:`public processConfirmResponseREST\($response\)<Firstred\\PostNL\\Service\\ConfirmingServiceInterface::processConfirmResponseREST\(\)>`
* :php:meth:`public buildConfirmRequestSOAP\($confirming\)<Firstred\\PostNL\\Service\\ConfirmingServiceInterface::buildConfirmRequestSOAP\(\)>`
* :php:meth:`public processConfirmResponseSOAP\($response\)<Firstred\\PostNL\\Service\\ConfirmingServiceInterface::processConfirmResponseSOAP\(\)>`
