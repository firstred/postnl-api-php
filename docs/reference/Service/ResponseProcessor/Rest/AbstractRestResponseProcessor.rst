...
.. php:class:: AbstractRestResponseProcessor


	:Parent:
		:php:class:`Firstred\\PostNL\\Service\\ResponseProcessor\\AbstractResponseProcessor`
...
* :php:meth:`protected validateResponse\($response\)<Firstred\\PostNL\\Service\\ResponseProcessor\\Rest\\AbstractRestResponseProcessor::validateResponse\(\)>`
...
.. rst-class:: protected
	...
	.. php:method:: protected validateResponse( $response)
